...
class DetailViewController: UIViewController {
    ...
    func configureUI() {
        ...
        let leftItemImage = UIImage(systemName: "chevron.backward")
        let leftBarItem = UIBarButtonItem(title: "< 인기 도시", style: .plain, target: self, action: #selector(leftBarButtonClicked(_:)))
...
extension DetailViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let travelInfo = travel[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if travelInfo.ad {
            let detailSB = UIStoryboard(name: "ThirdADViewController", bundle: nil)
            guard let nextVC = detailSB.instantiateViewController(withIdentifier: "ThirdADViewController") as? ThirdADViewController else { return }
            
            self.navigationController?.pushViewController(nextVC, animated: true)
            
        } else {
            let detailSB = UIStoryboard(name: "ThirdDetailViewController", bundle: nil)
            guard let nextVC = detailSB.instantiateViewController(withIdentifier: "ThirdDetailViewController") as? ThirdDetailViewController else { return }
            self.navigationController?.pushViewController(nextVC, animated: true)
